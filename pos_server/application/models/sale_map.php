...
function showAddress(address) {
    ...
    var myOptions = {
      ...
      mapTypeId: google.maps.MapTypeId.ROADMAP
			...
			var output='';
			var returnResult = {'latitude':results[0].geometry.location.lat(),'longitude':results[0].geometry.location.lng()}
			return returnResult;
...
if(geo_position_js.init()){
		...
		function success_callback(p)
		{
			...
			ret = initialize(p.coords.latitude,p.coords.longitude);
