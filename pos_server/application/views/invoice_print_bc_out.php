...
body{line-height:1;width: 580px; }
...
.invoice_form .logotype{margin:2px auto;width:580px;}
...
.invoice_form .block1{position:relative;float:none;width:580px;}
...
<dd class="block1" >
                        ...
                        <table class="table_box" style="text-align:center;">
                            <tr>
                                <td>
                                    <div class="logotype"><img src="/images/2019logobw.png" /></div>
                                ...
                                <td>
                                    <table class="table_box type_2">
                                          ...
                                          <td colspan="2">
                                                   ...
                                                   <img  style="min-height:80px;width:408px" src="<?=$bcT?>">   
                                                   
                                              <!--
                                                  <img  style="height:0.7cm;width:98%" src="/upload/invoice/<?=$invoiceInf['year']?>/<?=$invoiceInf['period']?>/<?=$code?>.gif">
                                            -->
                                                  </td>
                                                                          
                                        </tr>
                                        <tr>
                                         <td style="padding:0"><img style="height:85px;width:85px" src="<?=$qrT?>"></td>
                                          <td style="padding:0"><img style="height:85px;width:85px" src="<?=$qrT2?>"></td>
                          
                                        </tr>
                                       </table>
                                </td>
                            </tr>
                            <tr><td style="font-size:0.3cm"><?=$invoiceInf['shopName']?></td></tr>
                            <tr>
    ...
    <?php endif;?>                   
                        ...
                        <table class="table_box type_1">
                            ...
                            <tr>
                                <td>
                                    <ul>
                                             <li>小計：<?=number_format($subTotal)?></li>
                                    ...
                                    <h5>交易明細-續</h5>                                   
                                     ...
                                     <?php 
                                                  do
                                                {
                                                    ...
                                                    $out = mb_strimwidth($str, 0,22,'', 'UTF-8');
                            ...
                            <tr>
                                <td>
                                    <ul>
                                         ...
                                         <?php endif?>
                                        <li  class="sp">若商品有瑕疵或缺件請攜帶此憑證七天內到原購買店進行補件或更換</li>                                       
